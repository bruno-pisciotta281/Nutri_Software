...
<body>
    <div class="container">
        ...
        <p style="font-size: 15px;">Edite as informações do usuário abaixo como: <strong> nome, email e nível</strong>. Depois clique em atualizar para alterar os dados do usuário.</p>
        <hr class="soon2">
